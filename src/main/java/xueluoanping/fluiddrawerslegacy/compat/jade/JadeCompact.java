...
public class JadeCompact implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerBlockDataProvider(ControllerProviderFixer.INSTANCE, BlockControllerIO.class);
    }
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(ControllerProviderFixer.INSTANCE,  BlockControllerIO.class);
